...
namespace DAO
{
    public class ProductDAO
    {
        ...
        public DataTable getAllProduct()
        {
            ...
            {
                con.Open();
                SqlCommand cmd = new SqlCommand("select C.CategoryName, P.ProductId,  P.ProductName, P.Unit, P.ImportPrice, P.PriceToSell, P.Quantity, P.ProductImg, P.StatusItem from Product as P, Category as C where P.CategoryId = C.CategoryId;", con);
        ...
        public bool insertProduct(ProductDTO newProductDTO)
        {
            ...
            {
                con.Open();
                SqlCommand cmd = new SqlCommand("insert into Product values (@ProductImg, @ProductName, @ImportPrice, @PriceToSell, @Unit, @Quantity, @StatusItem, @CategoryId)", con);
        ...
        public bool updateProduct(ProductDTO productDTO)
        {
            ...
            {
                con.Open();
                SqlCommand cmd = new SqlCommand("update Product set ProductName = @ProductName, ProductImg = @ProductImg, ImportPrice = @ImportPrice, PriceToSell = @PriceToSell, Unit = @Unit, Quantity = @Quantity, StatusItem = @StatusItem, CategoryId = @CategoryId where ProductId = @ProductId", con);

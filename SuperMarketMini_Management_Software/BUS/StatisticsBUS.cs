...
namespace BUS
{
    public class StatisticsBUS
    {
        ...
        public DataTable getAllStaffbyFilter(string keyword, DateTime dateFrom, DateTime dateTo, double from, double to)
        {
            ...
            dtStaff = dateFrom != DateTime.MinValue ? statisticsDAO.getAllStaffByDate(dateFrom.ToString(), dateTo.ToString()) : statisticsDAO.getAllStaff();
        ...
        public DataTable getAllCustomerByFilter(string keyword, DateTime dateFrom, DateTime dateTo, double from, double to)
        {
            ...
            dtCustomer = dateFrom != DateTime.MinValue ? statisticsDAO.getAllCustomerByDate(dateFrom.ToString(), dateTo.ToString()) : statisticsDAO.getAllCustomer();
